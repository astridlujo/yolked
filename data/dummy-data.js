...
export const CATEGORIES = [
    new Category('c1', 'Italian', '#86A873'),
    new Category('c2', 'Quick & Easy', '#8BB8A8'),
    new Category('c3', 'American', '#9F4A54'),
    new Category('c4', 'German', '#f5d142'),
    new Category('c5', 'Vegan', '#E5B25D'),
    new Category('c6', 'Dessert', '#507DBC'),
    new Category('c7', 'Breakfast', '#B38D97'),
    new Category('c8', 'Asian', '#b9ffb0'),
    new Category('c9', 'French', '#ffc7ff'),
    new Category('c10', 'Drinks', '#47fced')
];
